...
namespace BlockadeLabsSDK
{
    public sealed class SkyboxEndpoint : BlockadeLabsBaseEndPoint
    {
        ...
        /// </summary>
        /// <param name="searchQueryParameters">Optional, <see cref="HistorySearchQueryParameters"/>.</param>
        /// <param name="cancellationToken">Optional, <see cref="CancellationToken"/>.</param>
        /// <returns><see cref="SkyboxHistory"/>.</returns>
        public async Task<SkyboxHistory> GetSkyboxHistoryAsync(HistorySearchQueryParameters searchQueryParameters = null, CancellationToken cancellationToken = default)
        {
            var historyRequest = searchQueryParameters ?? new HistorySearchQueryParameters();
